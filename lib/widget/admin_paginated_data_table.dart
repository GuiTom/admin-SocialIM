...
class AdminPaginatedDataTable extends StatefulWidget {
  ...
  /// particular [AdminPaginatedDataTable] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [AdminPaginatedDataTable]
  ...
  /// To modify the border or background color of the [AdminPaginatedDataTable], use
  /// [CardTheme], since a [Card] wraps the inner [DataTable].
  AdminPaginatedDataTable({
    super.key,
    this.header,
    this.actions,
  ...
  final Future Function(int value)? onPageChanged;
  ...
  final Future Function(int? value)? onRowsPerPageChanged;

  /// The data source which provides data to show in each row. Must be non-null.
  ///
  /// This object should generally have a lifetime longer than the
  /// [AdminPaginatedDataTable] widget itself; it should be reused each time the
  /// [AdminPaginatedDataTable] constructor is called.
  ...
  @override
  AdminPaginatedDataTableState createState() => AdminPaginatedDataTableState();
}

/// Holds the state of a [AdminPaginatedDataTable].
///
/// The table can be programmatically paged using the [pageTo] method.
class AdminPaginatedDataTableState extends State<AdminPaginatedDataTable> {
  ...
  @override
  void didUpdateWidget(AdminPaginatedDataTable oldWidget) {
  ...
  void pageTo(int rowIndex) async {
    ...
    if ((widget.onPageChanged != null) &&
      ...
      await widget.onPageChanged!((_firstRowIndex~/rowsPerPage)+1);
    }
    setState(() {});
  }
  ...
  bool _isLastPageUnavailable() =>
      !_rowCountApproximate &&
          (_firstRowIndex < ((_rowCount/widget.rowsPerPage).ceil()-1)*widget.rowsPerPage);
    ...
    footerWidgets.addAll(<Widget>[
      ...
      if (widget.showFirstLastButtons)
        IconButton(
          ...
          onPressed: _isLastPageUnavailable()
              ? _handleLast
              : null,
        ),
